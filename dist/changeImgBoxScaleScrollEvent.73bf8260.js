...
var contentWrapper = document.querySelector('.content-first-wrapper');
var contentModel = document.querySelector('.content-first-model');
var contentBtn = document.querySelector('.content-first-btn-box');
...
window.addEventListener('scroll', function () {
  ...
  if (innerHeight > startHeight && startHeight > innerHeight - 300) {
    content.style.cssText = "transform: scale(".concat(0.5 + (innerHeight - startHeight) / 600, ")");
  }
});
